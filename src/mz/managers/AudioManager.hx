...
extern class AudioManager {
	...
	public static function pdateCurrentBgm(bgm:AudioParameters, pos:Float):Void;
	...
	public static function updateCurrentBgs(bgs:AudioParameters, pos:Float):Void;
	...
	public static function updateSeParameters(buffer:AudioParameters, se:AudioParameters):Void;
	...
	public static function updateBufferParameters(buffer:AudioParameters, configVolume:Int, audio:AudioParameters):Void;
	...
	public static function playEncryptedBgm(bgm:AudioParameters, ?pos:Float):Void;
	public static function createDecryptBuffer(url:String, bgm:AudioParameters, ?pos:Float):Void;
}
