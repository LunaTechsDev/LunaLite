...
extern class Bitmap {
  ...
  /**
     ...
     */
      ...
      */
     public function fillRect(x: Int, y: Int, width: Int, height: Int, color: String): Void;
      ...
      */
     public function drawCircle(x: Float, y: Float, radius: Float, color: String): Void;
     ...
     public function drawText(text: String, x: Int, y: Int,
              maxWidth: Int, lineHeight: Int, align: String): Void;
      ...
      */
     public function bltImage(source: Bitmap, sx: Int, sy: Int, sw: Int, sh: Int, dx: Int, dy: Int, ?dw: Int, ?dh: Int): Void;
      ...
      * @private
      */
     private function _drawTextOutline(text: String, tx: Int, ty: Int, maxWidth: Int): Void;
      ...
      * @private
      */
     private function _drawTextBody(text: String, tx: Int, ty: Int, maxWidth: Int): Void;
