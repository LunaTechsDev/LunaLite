...
extern class _Window extends Container {
   ...
   */
  public function setCursorRect(?x: Float, ?y: Float, ?width: Float, ?height: Float): Void;
  ...
  private var  _windowSpriteContainer: Container;
  private var  _windowBackSprite: Sprite;
  private var  _windowCursorSprite: Sprite;
  private var  _windowFrameSprite: Sprite;
  private var  _windowContentsSprite: Sprite;
  private var  _windowArrowSprites: Array<Any>;
  private var  _windowPauseSignSprite: Sprite;
