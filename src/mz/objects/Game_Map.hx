...
extern class Game_Map {
 ...
 public function changeBattleback(battleback1Name:String, battleback2Name:String):Void;

 public function changeParallax(name:String, loopX:Bool, loopY:Bool, sx:Int, sy:Int):Void;
