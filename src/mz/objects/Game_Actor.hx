...
extern class Game_Actor extends Game_Battler {
  ...
  * @memberof Game_Actor
  */
 public function tradeItemWithParty(newItem:EquipItem, oldItem:EquipItem):Bool;
 ...
 public function setCharacterImage(characterName:String, characterIndex:Int):Void;
  ...
  * @memberof Game_Actor
  */
 public function startAnimation(animationId:Int, mirror:Bool, delay:Int):Void;
