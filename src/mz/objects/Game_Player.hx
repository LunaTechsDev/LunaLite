...
import mz.types.RPG.MapEncounter;
...
extern class Game_Player extends Game_Character {
  ...
  * @memberof Game_Player
  */
 public function reserveTransfer(mapId:Int, x:Int, y:Int, ?d:Int, ?fadeType:Int):Void;
  ...
  * @memberof Game_Player
  */
 public function startMapEvent(x:Int, y:Int, triggers:Array<Int>, normal:Bool):Void;
