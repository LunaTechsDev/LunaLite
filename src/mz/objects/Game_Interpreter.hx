...
import mz.types.RPG.EventCommand;
 ...
 */
 ...
 extern class Game_Interpreter {
  ...
  public function iterateActorId(param: Int, callback: (actor: Game_Actor) -> Void): Void;
  public function iterateActorEx(param1: Int, param2: Int, callback: (actor: Game_Actor) -> Void): Void;
  public function iterateActorIndex(param: Int, callback: (actor: Game_Actor) -> Void): Void;
  public function iterateEnemyIndex(param: Int, callback: (enemt: Game_Enemy) -> Void): Void;
  public function iterateBattler(param1: Int, param2: Int, callback: (battler: Game_Battler) -> Void): Void;
  public function character(param: Int): Game_Character;
  public function operateValue(operation: Int, operandType: Int, operand: Int): Int;
  ...
  public function operateVariable(variableId: Int, operationType: Int, value: Int): Void;
