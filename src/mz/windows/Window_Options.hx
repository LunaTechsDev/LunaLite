...
extern class Window_Options extends Window_Command {
  public function new();
    ...
    public function changeValue(symbol: String, value: EitherType<Bool, Float>): Void;
    public function getConfigValue(symbol: String): Bool;
    public function setConfigValue(symbol: String, volume: EitherType<Bool, Float>): Void;
}