...
public function   tpCostColor(): String;
    ...
    * @memberof Window_Base
    */
   public function drawText(text: EitherType<String, Int> , x: Int, y: Int, maxWidth: Int, align: String): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function processEscapeCharacter(code: String, textState: TextState): Void;
   /**
   ...
   public function drawFace(faceName: String, faceIndex: Int, x: Int, y: Int, width: Int, height: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawCharacter(characterName: String, characterIndex: Int, x: Int, y: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawGauge(x: Int, y: Int, width: Int, rate: Float, color1: String, color2: String):Void;
   /**
    ...
    * @memberof Window_Base
    */
public function   drawActorFace(actor: Game_Actor, x: Int, y: Int, width: Int, height: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorName(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorClass(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorNickname(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorIcons(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawCurrentAndMax(current: Float, max: Float, x: Int, y: Int, width: Int, color1: String, color2: String): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorHp(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorMp(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorTp(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawActorSimpleStatus(actor: Game_Actor, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawItemName(item: BaseItem, x: Int, y: Int, width: Int): Void;
   /**
    ...
    * @memberof Window_Base
    */
   public function drawCurrencyValue(value: Int, unit: String, x: Int, y: Int, width: Int): Void;
   /**
